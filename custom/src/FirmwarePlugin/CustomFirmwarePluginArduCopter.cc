...
//-----------------------------------------------------------------------------
CustomFirmwarePluginArduCopter::CustomFirmwarePluginArduCopter()
{
}

//-----------------------------------------------------------------------------
AutoPilotPlugin* CustomFirmwarePluginArduCopter::autopilotPlugin(Vehicle* vehicle) const
{
    return new CustomAutoPilotPluginAPM(vehicle, vehicle);
}

const QVariantList& CustomFirmwarePluginArduCopter::toolIndicators(const Vehicle* vehicle)
{

...
//-----------------------------------------------------------------------------
CustomFirmwarePluginArduPlane::CustomFirmwarePluginArduPlane()
{
}

//-----------------------------------------------------------------------------
AutoPilotPlugin* CustomFirmwarePluginArduPlane::autopilotPlugin(Vehicle* vehicle) const
{
    return new CustomAutoPilotPluginAPM(vehicle, vehicle);
}

const QVariantList& CustomFirmwarePluginArduPlane::toolIndicators(const Vehicle* vehicle)
{

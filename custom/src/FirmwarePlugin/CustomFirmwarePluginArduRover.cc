...
//-----------------------------------------------------------------------------
CustomFirmwarePluginArduRover::CustomFirmwarePluginArduRover()
{
}

//-----------------------------------------------------------------------------
AutoPilotPlugin* CustomFirmwarePluginArduRover::autopilotPlugin(Vehicle* vehicle) const
{
    return new CustomAutoPilotPluginAPM(vehicle, vehicle);
}

const QVariantList& CustomFirmwarePluginArduRover::toolIndicators(const Vehicle* vehicle)
{

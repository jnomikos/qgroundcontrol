...
//-----------------------------------------------------------------------------
CustomFirmwarePluginArduSub::CustomFirmwarePluginArduSub()
{
}

//-----------------------------------------------------------------------------
AutoPilotPlugin* CustomFirmwarePluginArduSub::autopilotPlugin(Vehicle* vehicle) const
{
    return new CustomAutoPilotPluginAPM(vehicle, vehicle);
}

const QVariantList& CustomFirmwarePluginArduSub::toolIndicators(const Vehicle* vehicle)
{

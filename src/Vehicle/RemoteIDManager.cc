...
void RemoteIDManager::_sendSystem()
{
    ...
    if (_settings->locationType()->rawValue().toUInt() == LocationTypes::FIXED) {
        ...
        QGeoPositionInfoSource::Error gcsPositioningError = QGCPositionManager::instance()->gcsPositioningError();
        QGeoCoordinate::CoordinateType lastCoordinateType = QGCPositionManager::instance()->lastCoordinateType();
